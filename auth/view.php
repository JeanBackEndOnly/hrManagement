            ...
            echo '<div class="col-md-12">';
               ...
               echo '<form id="signupFormEmp" action="../auth/authentications.php" method="post" enctype="multipart/form-data"
                    ...
                    echo '<div class="form-group row w-100 ms-1" id="st-step">';
                        ...
                        //         echo '<input type="number" name="salary_Range_From" id="salary_Range_From" class="form-control p-1 py-2 rounded-1" placeholder="Salary Range From:" value="' . (isset($signup_data['salary_Range_From']) ? htmlspecialchars($signup_data['salary_Range_From']) : '') . '">';
                        //     echo '</div>';

                        //     echo '<div class="col-12 col-md-6 mb-2 px-1">';
                        //         echo '<label for="salary_Range_To" class="mb-0" style="color:red; font-weight:400 !important;">Required</label>';
                        //         echo '<input type="number" name="salary_Range_To" id="salary_Range_To" class="form-control p-1 py-2 rounded-1" placeholder="Salary Range To:" value="' . (isset($signup_data['salary_Range_To']) ? htmlspecialchars($signup_data['salary_Range_To']) : '') . '">';
                        //     echo '</div>';
                        // echo '</div>';
                        ...
                        echo '<div class="col-md-12 d-flex flex-wrap w-100 px-0 justify-content-center">';
                            ...
                            //     echo '<input type="number" name="salary" id="salary" class="form-control p-1 py-2 rounded-1" placeholder="Official Salary:" value="' . (isset($signup_data['salary']) ? htmlspecialchars($signup_data['salary']) : '') . '">';
                            // echo '</div>';
                            echo '<div class="col-12 col-md-6 mb-2 px-1">';
                    ...
                    echo '<div class="form-group row w-100 ms-1 mb-4" id="nd-step" style="display: none;">';
                        ...
                        echo '<div class="col-md-12 d-flex flex-wrap w-100 px-0 justify-content-center">';
                            echo '<div class="col-12 col-md-6 px-1">';
                                ...
                                echo '<select name="secheduleFrom" id="scheduleFrom" class="form-select p-1 py-2 rounded-1">';
                        ...
                        echo '</div>';
                        echo '<div class="w-100 px-0 d-flex flex-row justify-content-center align-items-center">';
               ...
               echo '<form id="signupForm" action="../../auth/authentications.php" method="post" enctype="multipart/form-data"
                    ...
                    echo '<div class="form-group row w-100 ms-1" id="st-stepA">';
                        ...
                        echo '<div class="col-md-12 d-flex flex-wrap w-100 px-0 justify-content-center">';
                            ...
                            echo '</div>';
                        echo '</div>';
                        echo '<div class="col-md-12 d-flex flex-wrap w-100 px-0 justify-content-center mb-2">';
                            echo '<div class="col-12 col-md-6 px-1">';
                                echo '<label for="fname" class="mb-0" style="color:#000; font-weight: 400 !important">Optional</label>';
                                echo '<select name="religion" id="religion" class="form-select p-1 py-2 rounded-1">';
                                    echo '<option value=""' . (!isset($signup_data['religion']) ? ' selected' : '') . '>Select Religion</option>';
                    ...
                    echo '<div class="form-group row w-100 ms-1 mb-4" id="nd-stepA" style="display: none;">';
                        ...
                        echo '</div>';
                        echo '<div class="row w-100 px-0 justify-content-center">';
