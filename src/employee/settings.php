            ...
            <div class="contents w-100 h-100 d-flex flex-column align-items-center p-0 m-0">
                <div class="header-employee d-flex flex-row justify-content-between align-items-center" style="min-height: 7rem; min-width: 95%;">
                    ...
                    <div class="navigations">
                        <button type="button" id="Personal" onclick="activateTab(this); personalInfo()" class="tab-btn active">Change Password</button>
                        <button type="button" id="Family" onclick="activateTab(this); familyBG()" class="tab-btn">Login History</button>
                    </div>
                </div>
            </div>
        </div>
