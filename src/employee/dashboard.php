        ...
        <div class="d-flex w-100 align-items-start" style="height: auto;">
            ...
            <div class="contents w-100 h-100 d-flex flex-column justify-content-center align-items-center p-0 m-0">
                <div class="header-employee mediaTitleMargin m-0 d-flex flex-row justify-content-start align-items-center col-md-11 col-11 flex-wrap" style="height: 5rem !important;">
                    <div class="h1 AnimationFinalfirst text-start col-md-11 col-11">
                        <h3 class="m-0 titleFont fontSizeMedia col-md-12 col-12 ">DASHBOARD</h3>
                        <p style="font-size: 17px !important; margin-top: -1rem !important; col-md-12 col-12"><span class="fontSizeMediaP">Here are your some important features</span></p>
                    </div>
                </div>
