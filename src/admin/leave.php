...
<body>
    ...
    <div class="row">
        ...
        <div class="contentss">
            <div class="headerL">
                ...
                <button type="button" onclick="Lrequest()">Leave Request <span id="leaveCountDisplay"></span></button>
                ...
                <div class="breavement-leave">
                    ...
                    <div class="backening">
                        ...
                        <form action="../../auth/authentications.php" method="post" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="leave" value="admin">
            ...
            <div class="hiddenLeaveRequest" id="hiddenLeaveRequest" style="display: none;">
                <div class="backToLeave">
                    <button type="button" id="buttonNani" onclick="heheBack()"><i class="fa-solid fa-arrow-left"></i></button><h3 id="h">Leave Request</h3>
                </div>
            ...
            <div class="hiddenAksep" id="hiddenAksep" style="display:none;">
                <p id="updateP">Accept Leave Request?</p>
                <form action="" id="acceptLeave" method="post">
                <input type="hidden" name="csrf_token" value="<?php echo $csrf_token; ?>">
                <input type="hidden" value="admin" name="accept">
                <!-- <input type="hidden" value="" id="leaveIDs" name="leaveID"> -->
                <div class="nanii">
                    <button type="submit" id="edit">Yes</button>
                </form>
                <button type="button" id="view" onclick="cancelThis()">no</button>
                </div>
            </div>
            <div class="hiddenDeleteRequest" id="hiddenDeleteRequest" style="display:none;">
                <p id="updateP">Reject Leave Request?</p>
                <form action="" id="RejectLeaveRequest" method="post">
                <input type="hidden" name="csrf_token" value="<?php echo $csrf_token; ?>">
                <input type="hidden" value="admin" name="deleteLeave">
                <!-- <input type="hidden" value="" id="leaveIDs" name="leaveID"> -->
                <div class="nanii">
                    <button type="submit" id="edit">Yes</button>
                </form>
   ...
   ?>
    ...
    <script src="../../assets/js/hr/leave.js"></script>
    <script>
       document.addEventListener('DOMContentLoaded', function () {
    fetch('../api/ajax.php')
        .then(response => response.json())
        .then(data => {
            if (data.pendinLeaveCount !== undefined) {
                document.getElementById('leaveCountDisplay').textContent = data.pendinLeaveCount;
            } else {
                console.error('pendinLeaveCount not found in response:', data);
            }
        })
        .catch(error => {
