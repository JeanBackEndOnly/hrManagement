            ...
            <div class="container mediaLogin col-md-4 col-10 d-flex shadow flex-column align-items-center h-auto justify-content-center m-0 p-0 pb-2 rounded-bottom-4"
                ...
                <form method="POST" action="../../auth/authentications.php" class="modal-content">
                    ...
                    <div class="emailAuth w-100 d-flex flex-column justify-content-start align-items-start m-0 py-3 px-4">
                        ...
                        <input type="text" name="mailCode" id="emailLabel"
                            class="form-control w-100 text-center fw-bold p-2 fs-6" placeholder="Authentication Code"
                            required>
                    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    if (mfa) {
        ...
        Swal.fire({
            ...
            position: 'top-end',
            icon: 'success',
            title: 'Mail code resend successfully!.',
            showConfirmButton: false,
            timer: 3000,
            timerProgressBar: true,
            customClass: {
