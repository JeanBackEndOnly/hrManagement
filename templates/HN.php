...
<?php function renderHeaderEmployee() { ?>
    ...
    <div class="headerFixer w-100 d-flex" >
        <div class="header roundedMedia d-flex header-bg align-items-center justify-content-between px-2 m-0 col-md-12 col-11" style="height: 60px; max-width: 100%;">
            ...
            <div class="usersButton d-flex align-items-center justify-content-end col-md-6 col-4 m-0 p-0">
                <a href="settings.php" class="d-flex align-items-center"><i class="fa-solid text-white fa-gear settingsNavI fs-5" style="color: #fff;"></i></a>
                <button class="me-4" style="background: none; border:none; width: 20px;" onclick="logoutButton()"><i class="fa-solid text-white fa-right-from-bracket ms-3 me-3 fs-5" style="color: #fff;"></i></button>
                <a href="profile.php?users_id=<?= $EmployeeData["users_id"] ?>" class="m-0 p-0 d-flex align-items-center">
                    <img src="../../assets/image/upload/<?= htmlSpecialChars($EmployeeData["user_profile"]) ?>" alt="" style="width: 45px; height: 45px; border-radius: 50%;" class="hideMedia ms-3 me-3">
        ...
        <div class="logout flex-column LogoutAniamtion " id="logoutDiv" class="p-3" style="position: fixed; transform: translate(-50%, -50%); top:50%; left:50%; display: none; z-index: 55;">
            <div class="shadow rounded p-0 logoutMediaWidth" style="background-color: #fff !important;">
                ...
                <div class="buttons d-flex flex-row justify-content-evenly w-100 mt-1 pb-4">
                    ...
                    <button id="logoutNo" class="col-md-5 btn btn-secondary btn-sm mt-2 buttonLogoutMedia" onclick="logoutNo()">No</button>
                </div>
            </div>
        </div>
    </div>
