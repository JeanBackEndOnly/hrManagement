...
<?php function renderHeader() { ?>
    <div class="header d-flex header-bg align-items-center justify-content-between px-3" style="height: 60px; min-width: 100%;">
...
<?php function renderNav() { ?>
    <div class="sideNav p-0 BGGradiantNav" id="sideHEhe">
        <div class="navs p-0 m-0  w-auto">
            <li class="dashboardLi d-flex align-items-center mb-2">
                <a class="p-2 d-flex m-0" href="dashboard.php" class="d-flex align-items-center w-100">
                    ...
                    <p class="text-start text-black side-text m-0" id="pdashboard">Dashboard</p>
                </a>
            </li>
            <li class="hrLi d-flex align-items-center mb-2 w-100">
                <button type="button" onclick="hrButton()" class="p-0 m-0 w-100 h-100 d-flex align-items-center p-2">
                    <i id="hri" class="fa-solid text-black me-2 fa-users"></i>
                    <p class="text-start text-black side-text" id="phr">HR Management</p>
                    <i id="iLeftArrowHr" class="fa-solid text-black fa-chevron-left" style="display:none;"></i>
                </button>
            </li>
            ...
            <li class="payrollLi d-flex align-items-center mb-2">
                <button type="button" onclick="payrollButton()" class="p-0 m-0 w-100 h-100 d-flex align-items-center p-2">
                    <i id="payrolli" class="fa-solid text-black me-2 fa-peso-sign"></i>
                    <p class="text-start text-black side-text" id="ppr">Payroll Management</p>
                    <i id="iLeftArrowPr" class="fa-solid text-black fa-chevron-left" style="display:none;"></i>
                </button>
            </li>
            ...
            <li class="attendanceLi d-flex align-items-center mb-2">
                <a class="p-2 d-flex m-0" href="#" class="p-0 m-0 w-100 h-100 d-flex align-items-center">
                    <i class="fa-solid text-black me-2 fa-clock"></i>
                    <p class="text-start text-black side-text" id="pa">Attendance</p>
                </a>
            </li>
            ...
            <li class="settingsLi d-flex align-items-center mb-2">
                <a class="p-2 d-flex m-0" href="settings.php" class="p-0 m-0 w-100 h-100 d-flex align-items-center">
                    <i class="fa-solid text-black me-2 fa-gear"></i>
                    <p class="text-start text-black side-text" id="ps">Settings</p>
                </a>
            </li>
        </div>
